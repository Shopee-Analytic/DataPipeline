...
@dag(default_args=DEFAULT_ARGS, schedule_interval=None, start_date=days_ago(0), tags=['datapipeline-etl_1'], concurrency=randint(5, 10), max_active_runs=randint(10, 20), default_view='graph') # 
def airflow_etl():
